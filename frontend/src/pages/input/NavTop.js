      ...
      <>
            ...
            <Search placeholder="input search text" defaultValue={this.props.keyword}  allowClear onSearch={ function(){ this.props.onInput(this.input)}.bind(this)} style={{ width: 200 ,marginLeft : '2%',  marginTop : '0.5%'}} onChange={function (e) { this.input.keyword = e.target.value }.bind(this)} />
                <Input.Group compact style = {{marginTop : "0.5%" , marginLeft : "2%"}}>
                    ...
                    <InputNumber style={{ width: '20%' }} defaultValue={this.props.size[1] == -1 ? "" : this.props.size[1]} placeholder="어깨너비" onChange={function (e) { this.input.size[1] = Number(e) }.bind(this)}/>
                    <InputNumber style={{ width: '20%' }} defaultValue={this.props.size[2] ==-1 ? "" : this.props.size[2]} placeholder="가슴단면" onChange={function (e) { this.input.size[2] = Number(e) }.bind(this)}/>
                    <InputNumber style={{ width: '20%' }} defaultValue={this.props.size[3] == -1 ? "" : this.props.size[3]} placeholder="소매길이" onChange={function (e) { this.input.size[3] = Number(e) }.bind(this)}/>
                </Input.Group>
            </>
        );
