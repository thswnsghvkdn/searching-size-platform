...
function MainTop (props) {
    ...
    let [filteringRage, setRange] = useState(3)
    ...
    return (
        <div style= {{height : '100%'  , width : '80%',  display : 'flex' , flexWrap : 'nowrap', justifyContent : 'center', position :'relative',  marginTop : '10px'}}>
            ...
            <Form style={{ position : "relative" , top :'0' , left : '5%' , display : "inline-block" }}>
                ...
                <Slider marks = {sliderMarks} defaultValue={1} onChange = {function(e) {  setRange(e) }} min ={1} max = {10} tipFormatter = {sliderTooltipFormatter} />
                ...
                <Button multiple onClick = {function() { props.onSearch(search , keyword ,filteringRage)} } style={{ margin: '0.5rem', width: '200px' }}>검색</Button>
            </Form>
            {humanImage}
        </div>
    );
